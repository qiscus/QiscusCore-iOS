...
HeartBeat is something like your heart and every TimeInterval (default is 30s) QiscusCore will check connectivity to RealtimeServer. If you decide to server, QiscusCore will activate the sync sync automatically. and you can set time intervals, but we recommend more than 5/10 (s) to optimize resources.
...
QiscusCoreDelegate all event provide by qiscuscore will presented here.
...
You can listen event only on specific room with QiscusCoreRoomDelegate. 
